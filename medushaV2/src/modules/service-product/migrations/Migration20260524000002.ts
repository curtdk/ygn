  ...
  override async up(): Promise<void> {
    this.addSql(`
      create table if not exists "service_product" (
        ...
        "profit_sharing_level1" numeric not null default 0.10,
        "profit_sharing_level2" numeric not null default 0.05,
        "profit_sharing_level3" numeric not null default 0.02,
    ...
    this.addSql(`
      create table if not exists "service_order" (
        ...
        "notes" text null,
        "grab_records" text null,
        "assigned_provider_id" text null,
        "auto_complete_at" timestamptz null,
        "service_address_contact" text null,
        "service_address_phone" text null,
        "created_at" timestamptz not null default now(),
        "updated_at" timestamptz not null default now(),
        "deleted_at" timestamptz null,
